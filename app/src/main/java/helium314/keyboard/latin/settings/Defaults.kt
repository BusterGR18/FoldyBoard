...
object Defaults {
    ...
    @JvmField
    val PREF_BACKGROUND_BRIGHTNESS_DAY_PORT = arrayOf(DEFAULT_BRIGHTNESS)

    @JvmField
    val PREF_BACKGROUND_BRIGHTNESS_DAY_LAND = arrayOf(DEFAULT_BRIGHTNESS)

    @JvmField
    val PREF_BACKGROUND_BRIGHTNESS_NIGHT_PORT = arrayOf(DEFAULT_BRIGHTNESS)

    @JvmField
    val PREF_BACKGROUND_BRIGHTNESS_NIGHT_LAND = arrayOf(DEFAULT_BRIGHTNESS)
